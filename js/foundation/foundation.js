...
(function ($, window, document, undefined) {
  ...
  if($('head').has('.foundation-mq-sgrid').length === 0) {
    $('head').append('<meta class="foundation-mq-sgrid">');
  }

  if($('head').has('.foundation-mq-grid').length === 0) {
    $('head').append('<meta class="foundation-mq-grid">');
  }

  if($('head').has('.foundation-mq-lgrid').length === 0) {
    $('head').append('<meta class="foundation-mq-lgrid">');
  }

  if($('head').has('.foundation-mq-xlgrid').length === 0) {
    $('head').append('<meta class="foundation-mq-xlgrid">');
  }

  if($('head').has('.foundation-mq-xxlgrid').length === 0) {
    $('head').append('<meta class="foundation-mq-xxlgrid">');
  }
  ...
  */
  ...
  window.Foundation = {
    ...
    media_queries : {
      sgrid : S('.foundation-mq-sgrid').css('font-family').replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ''),
      grid : S('.foundation-mq-grid').css('font-family').replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ''),
      lgrid : S('.foundation-mq-lgrid').css('font-family').replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ''),
      xlgrid: S('.foundation-mq-xlgrid').css('font-family').replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, ''),
      xxlgrid: S('.foundation-mq-xxlgrid').css('font-family').replace(/^[\/\\'"]+|(;\s?})+|[\/\\'"]+$/g, '')
    },
